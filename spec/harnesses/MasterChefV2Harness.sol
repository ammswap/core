...
contract MasterChefV2Harness is MasterChefV2 {
    ...
    ////////////////////////////////////////////////////////////////////////////
    constructor(IMasterChef _MASTER_CHEF, IERC20 _reward, uint256 _MASTER_PID)
                    MasterChefV2(_MASTER_CHEF, _reward, _MASTER_PID) public { }
    ...
    function poolInfoAccRewardPerShare(uint256 pid) public view returns (uint128) {
        return poolInfo[pid].accRewardPerShare;
    }
    ...
    mapping(uint256 => uint256) symbolicRewardPerBlock; // random number
    function rewardPerBlock() public view override returns (uint256 amount) {
        return symbolicRewardPerBlock[block.number];
    }
