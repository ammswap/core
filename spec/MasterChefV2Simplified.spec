...
methods {
	...
	// overrided methods
	rewardPerBlock() returns (uint256 amount)
	...
	// REWARD token
	REWARD() returns (address) envfree // NOT USED
	rewardToken.balanceOf(address) returns (uint256) // NOT USED
	...
	// Rewarder
	// SIG_ON_REWARD_REWARD = 0xbb6cc2ef; // onTokenReward(uint256,address,uint256)
	0xbb6cc2ef => NONDET
