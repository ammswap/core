...
# Adding virtual to rewardPerBlock()
perl -0777 -i -pe 's/function rewardPerBlock\(\) public view returns/function rewardPerBlock\(\) public view virtual returns/g' contracts/MasterChefV2.sol
